...
%
% Merge energy balance 깨져있는 부분 수정
% Quasi-steady state module 개발중
% 
% Major Update : KAIST-ESCA (+Q), V1.1 170914
%
% Quasi 모듈 첫추가
% Quasi 에서 열교환기는 상수 압력강하만 허용하도록.
%
% Major Update : KAIST-ESCA (+Q), V1.2 171030
%
% WHR Steady solver 추가 (민군과제)
%
% Minor Update : KAIST-ESCA (+Q), V1.2.1 171107
%
% 민군 Input deck 추가
% Error shooting 필요 -> solver가 도는 과정에서 한 값을 결정할 때 마다 어떤 Equation을 썼는지에 대한
% 정보를 저장하는 식으로 바꿔야함.
%
