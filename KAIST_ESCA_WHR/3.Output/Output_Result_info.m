...
disp(str)
disp(' ')
str=sprintf('%50s %30s', 'IHX/WHR name', 'Inlet Heat(MW)');
disp(str)
for i=1:size(Component, 2)
    ...
    elseif(strcmp(Component(i).type, 'WHR'))
        Q = Junc(Component(i).inJunc(1)).m_flow_rate * abs(refpropm('H', 'T', Junc(Component(i).inJunc(1)).T, 'P', Junc(Component(i).inJunc(1)).P, Condition.Fluid) - ...
