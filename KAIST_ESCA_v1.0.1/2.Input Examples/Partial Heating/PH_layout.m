...
Component(5).P_target = -1; % Max P 까지를 나타내는 indicator
Component(5).inJunc = 4;
Component(5).outJunc = 5;
Component(5).index = 1;
Component(5).split = -1;

Component(6).type = 'IHX';
Component(6).ID = 'Sub heater';
Component(6).index = 2;
Component(6).inJunc = 6;
Component(6).outJunc = 9;
Component(6).split = 1;
