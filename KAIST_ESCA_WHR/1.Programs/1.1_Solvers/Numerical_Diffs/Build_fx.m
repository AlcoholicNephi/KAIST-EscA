    ...
    switch(Component(i).type)
        ...
        case 'WHR'
            if(Mechanics.WHR(Component(i).index).dP(1) > 0)
                ...
                f_x(cnt, Component(i).outJunc(1)) = 1;
                f_x(cnt, Component(i).inJunc(1)) = -(1+Mechanics.WHR(Component(i).index).dP(1));
            end
            cnt = cnt+1;
            ...
            if(Mechanics.WHR(Component(i).index).dP(2) > 0)
                ...
                f_x(cnt, Component(i).outJunc(2)) = 1;
                f_x(cnt, Component(i).inJunc(2)) = -(1+Mechanics.WHR(Component(i).index).dP(2));
            end
            cnt = cnt+1;
        ...
        case 'Junction'
            if(size(Component(i).inJunc, 2) == 1)
                ...
                if(Component(i).check == -1)
                    for j=1:size(Component(i).inJunc, 2)
                        f_x(cnt, Component(i).outJunc) = 1;
                        f_x(cnt, Component(i).inJunc(j)) = -1;
                        cnt = cnt+1;
                    end
                else
                    f_x(cnt, Component(i).outJunc) = 1;
