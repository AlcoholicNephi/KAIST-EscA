...
Mechanics.Compressor(1).P_ratio = 1.2;
...
Mechanics.Compressor(3).Rel_P_ratio = 1.0;
Mechanics.Compressor(3).indicator = -1; % Outlet condition indicator / -1: Bounded, 0: free, else : indicating. P target junction
Mechanics.Compressor(3).Eff = 0.70;
