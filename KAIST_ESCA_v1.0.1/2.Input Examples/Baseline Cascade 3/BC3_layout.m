...
Component(1).index = 1;
Component(1).inJunc = 18;
Component(1).outJunc = 1; % 약속 : Cycle에 연결된 channel이 먼저오도록
Component(1).split = 3;

Component(2).type = 'IHX';
Component(2).ID = 'Sub heater';
Component(2).index = 2;
Component(2).inJunc = 16;
Component(2).outJunc = 11; % 약속 : Cycle에 연결된 channel이 먼저오도록
Component(2).split = 1;
...
Component(9).ID = 'C1';
Component(9).P_target = 10400; % kPa
