...
Mechanics.Turbine(1).P_ratio = 1.8705;
...
Mechanics.Turbine(2).P_ratio = 1.3872;
...
Mechanics.Turbine(3).P_ratio = 1.3872;
Mechanics.Turbine(3).indicator = 3; % Outlet condition indicator / -1: Bounded, 0: free, else : indicating. P target junction
Mechanics.Turbine(3).Eff = 0.90;
